package io.dfjinxin.modules.auth.service.impl;


import io.dfjinxin.modules.auth.service.AuthService;
import io.dfjinxin.modules.auth.utils.CookieUtils;
import io.dfjinxin.modules.auth.utils.RestTemplateUtils;
import io.dfjinxin.modules.auth.utils.UrlEnum;
import io.dfjinxin.modules.auth.vo.OauthUserDTO;
...
//            refreshTokenCookie.setDomain(tokenDomain);
    ...
    private String getAuthorizationHeader(String clientId, String clientSecret) {
        ...
        try {
            ...
            String basicToken ="Basic " + encoder.encodeToString(creds.getBytes("UTF-8"));
            return basicToken;
